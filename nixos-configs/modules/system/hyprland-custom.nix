...
{
  # Provide a placeholder `wayland` option so modules can set `wayland.windowManager.*`
  options.wayland = lib.mkOption {
    type = lib.types.attrs;
    description = "Placeholder wayland option created by hyprland-custom to allow evaluation when stylix/wayland modules are not present";
    default = {};
  };
